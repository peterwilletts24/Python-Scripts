...
cs_col = m.contourf(x,y, swave_mean,  np.linspace(clev_min, clev_max, 16), cmap=cmap, extend='both')
...
plt.savefig('/nfs/a90/eepdw/Figures/ERA_Interim/Era_Interim_mean_EMBRACE_period_notitle_shortwave_energy_mean.png', format='png', bbox_inches='tight')

plt.suptitle('ERA-Interim Reanalysis Mean Shortwave Solar Radiation Flux for EMBRACE period', fontsize=16, color='#262626')
plt.savefig('/nfs/a90/eepdw/Figures/ERA_Interim/Era_Interim_mean_EMBRACE_period_shortwave_energy_mean.png', format='png', bbox_inches='tight')
