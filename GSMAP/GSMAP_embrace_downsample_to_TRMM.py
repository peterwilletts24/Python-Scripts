...
lats_data, lons_data, time_secs_data = np.meshgrid(numpy_cube['lons'], numpy_cube['lats'], timestamp_list)

data_regridded_to_trmm = griddata((lats_data, lons_data, time_secs_data), 
                            bad_values, (longitude_trmm, latitude_trmm, trmm_timestamp_list), method='linear')

np.save("/nfs/a90/eepdw/Data/Observations/Satellite/GSMAP_Aug_Sep_2011/gsmap_aug_sep_2011_regridded to_TRMM_lat_lon_and_time.py")
