...
np.savez("/nfs/a90/eepdw/Data/Observations/Satellite/CMORPH/Diurnal/total_CMORPH_diurnal_average_lat_%s_%s_lon_%s_%s" % (lat_low,lat_high, lon_low, lon_high), mean=mean, hour=hour )
np.savez("/nfs/a90/eepdw/Data/Observations/Satellite/CMORPH/Diurnal/sea_CMORPH_diurnal_average_lat_%s_%s_lon_%s_%s" % (lat_low,lat_high, lon_low, lon_high), mean=mean_o, hour=hour_o )
np.savez("/nfs/a90/eepdw/Data/Observations/Satellite/CMORPH/Diurnal/land_CMORPH_diurnal_average_lat_%s_%s_lon_%s_%s" % (lat_low,lat_high, lon_low, lon_high), mean=mean_l, hour=hour_l )
