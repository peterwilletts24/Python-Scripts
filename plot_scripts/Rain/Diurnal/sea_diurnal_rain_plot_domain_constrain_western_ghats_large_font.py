...
#trmm_file = "trmm_diurnal_average_lat_%s_%s_lon_%s_%s_western_ghats.npz" % (lat_min,lat_max, lon_min, lon_max)
trmm_file = "trmm_diurnal_average_western_ghats_polygon.npz"
#############
...
# Bit of formatting 
  ...
  plt.savefig('/nfs/a90/eepdw/Figures/EMBRACE/Diurnal/%s_%s_latlon_western_ghats_notitle_large_font.png' % (pp_filenodot, ls), format='png', bbox_inches='tight')

  plt.title('\n'.join(wrap('%s' % (t.title()), 1000,replace_whitespace=False)), fontsize=16, color='#262626')
  #plt.show()
  
  plt.savefig('/nfs/a90/eepdw/Figures/EMBRACE/Diurnal/%s_%s_latlon_western_ghats_large_font.png' % (pp_filenodot, ls), format='png', bbox_inches='tight')
  plt.close()
