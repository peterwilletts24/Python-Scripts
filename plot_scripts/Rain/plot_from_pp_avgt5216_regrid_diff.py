...
def main():
 ...
 # Get min and max latitude/longitude and unrotate  to get min/max corners to crop plot automatically - otherwise end with blank bits on the edges 
  ...
  #lon_box = lon_low_box, lon_low_box, lon_high_box, lon_high_box, lon_low_box
  #lat_box = lat_low_box, lat_high_box, lat_high_box, lat_low_box, lat_low_box
  #plt.plot(lon_box, lat_box,  transform=ccrs.PlateCarree())
