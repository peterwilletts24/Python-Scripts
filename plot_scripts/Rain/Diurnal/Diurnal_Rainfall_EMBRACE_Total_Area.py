...
## Satellite retrievals ##
 ...
 #print dates_trmm
  ...
  #pl=np.sort(pl,axis=1)
     ...
     l0=plt.legend(legendEntries, legendtext,title='Satellite', frameon=False, loc=9, prop={'size':12}, 
                 bbox_to_anchor=(0.31+bbox_anchor, 0,1, 1))
  ...
  # Change the legend label colors to almost black
     ...
     plt.savefig('%s/EMBRACE_Diurnal_rain_average_%s_%s_%s_notitle.png' % (save_dir, pp_filenodot, ls, type_of_plot),
     ...
     plt.savefig('%s/EMBRACE_Diurnal_rain_average_%s_%s_%s.png' % (save_dir, pp_filenodot, ls, type_of_plot),
                 format='png', bbox_inches='tight')
     plt.close()
