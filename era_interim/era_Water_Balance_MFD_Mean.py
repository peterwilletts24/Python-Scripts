...
ncmfd=Dataset('/nfs/a90/eepdw/Data/ERA_Iinterim_Heat_Rad_Fluxes/era_interim_netcdf_vertical_int_mfd.nc')
...
moisture_flux_divergence_in = ncmfd.variables['p84.162'][t_i_min:t_i_max+1,la_i_min:la_i_max+1, lo_i_min:lo_i_max+1]
...
moisture_flux_divergence_in = ncmfd.variables['p84.162'][t_i_min:t_i_max+1,la_i_min:la_i_max+1, lo_i_min:lo_i_max+1]
moisture_flux_divergence = np.mean((moisture_flux_divergence_in * convert_to_kg_m2_day), axis=0, dtype=np.float64)

evap_rate = (latent_mean/latent_heat_of_vapourisation)*convert_to_kg_m2_day

waterbalance = evap_rate - precip_mean - moisture_flux_divergence
m =\
...
plt.savefig('/nfs/a90/eepdw/Figures/ERA_Interim/Era_Interim_EMBRACE_period_vert_int_water_budget_notitle.png', format='png', bbox_inches='tight')

plt.suptitle('ERA-Interim Reanalysis Mean Vertically Integrated Water Budget for EMBRACE period', fontsize=16, color='#262626')

plt.savefig('/nfs/a90/eepdw/Figures/ERA_Interim/Era_Interim_EMBRACE_period_vert_int_water_budget.png', format='png', bbox_inches='tight')
