...
for experiment_id in experiment_ids:
 try:
    ...
    for a, dm in enumerate(data_to_save):
        ...
        fname = '/nfs/a90/eepdw/Data/EMBRACE/On_Heights_Interpolation_Data/%s_pressure_levels_interp_%s' % (dm,experiment_id)
        ds = dset[a]
...
#pdb.set_trace()
        ...
        save_as_cube.add_dim_coord(DimCoord(points=info_cube.coord('time').points.flatten(), long_name='time', standard_name='time', units=info_cube.coord('time').units),0)
