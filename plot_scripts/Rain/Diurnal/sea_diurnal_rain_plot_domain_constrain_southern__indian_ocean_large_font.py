...
trmm_file = "trmm_diurnal_average_lat_%s_%s_lon_%s_%s_southern_indian_ocean.npz" % (lat_min,lat_max, lon_min, lon_max)
...
#experiment_ids = ['djzny', 'djznq', 'djzns', 'djznw', 'dkjxq', 'dklyu', 'dkmbq', 'dklwu', 'dklzq' ] 
 ...
 for ls in ['sea']:
  ...
  #l0=plt.legend(legendEntries, legendtext,title='', frameon=False,  loc=9, bbox_to_anchor=(0.21, 0,1, 1))
...
# Bit of formatting 
  ...
  plt.savefig('/nfs/a90/eepdw/Figures/EMBRACE/Diurnal/%s_%s_latlon_southern_indian_ocean_notitle_large_font.png' % (pp_filenodot, ls), format='png', bbox_inches='tight')

  plt.title('\n'.join(wrap('%s' % (t.title()), 1000,replace_whitespace=False)), fontsize=16, color='#262626')
  #plt.show()
  
  plt.savefig('/nfs/a90/eepdw/Figures/EMBRACE/Diurnal/%s_%s_latlon_southern_indian_ocean_large_font.png' % (pp_filenodot, ls), format='png', bbox_inches='tight')
  plt.close()
