...
plt.savefig('/nfs/a90/eepdw/Figures/ERA_Interim/Era_Interim_mean_EMBRACE_period_notitle_total_energy_mean.png', format='png', bbox_inches='tight')

plt.suptitle('ERA-Interim Reanalysis Mean Longwave Thermal Radiation Flux for EMBRACE period', fontsize=16, color='#262626')
plt.savefig('/nfs/a90/eepdw/Figures/ERA_Interim/Era_Interim_mean_EMBRACE_period_total_energy_mean.png', format='png', bbox_inches='tight')
