...
# Bit of formatting 
  ...
  plt.savefig('/nfs/a90/eepdw/Figures/EMBRACE/Diurnal/%s_notitle_largeonly.png' %filename_nodot, format='png', bbox_inches='tight')
  
  plt.title('\n'.join(wrap('%s' % (t.title()), 1000,replace_whitespace=False)), fontsize=16)
  #plt.show()

  plt.savefig('/nfs/a90/eepdw/Figures/EMBRACE/Diurnal/%s_largeonly.png' % filename_nodot, format='png', bbox_inches='tight')
