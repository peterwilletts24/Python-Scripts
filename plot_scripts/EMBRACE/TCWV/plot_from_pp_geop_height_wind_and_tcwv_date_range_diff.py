...
for p_level in plot_levels:
        ...
        for experiment_id in experiment_ids:
                ...
                pfile = '/nfs/a90/eepdw/Data/EMBRACE/%s/%s/%s_%s_mean_by_date_range.pp' % (expmin1, experiment_id, experiment_id, pp_file_contourf)
                pfile_diff = '/nfs/a90/eepdw/Data/EMBRACE/%s/%s/%s_%s_mean_by_date_range.pp' % (diffmin1, diff_id, diff_id, pp_file_contourf)
                ...
                pcube_contourf=(pcube_contourf-pcube_contourf_diff)*-1000.
                ...
                for t, time_cube in enumerate(pcube_contourf.slices(['grid_latitude', 'grid_longitude'])):
                   ...
                   ################################### # PLOT ##############################################
                    ...
                    clevs = np.arange(min_contour, max_contour,tick_interval)
