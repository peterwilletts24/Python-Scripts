...
# Plot diagnostics, model and pressure levels etc. to plot on for looping through
 ...
 #experiment_ids = ['djznq', 'djzns', 'dkbhu']
...
Basemap(llcrnrlon=lon_low,llcrnrlat=lat_low,urcrnrlon=lon_high,urcrnrlat=lat_high, rsphere = 6371229)
        ...
        if plot_diag=='temp':
             ...
             cbar.set_label('K')  
             #plt.suptitle('Difference from 120km LAM model (Model - 120km LAM ) of Height, Potential Temperature and Wind Vectors  at %s hPa'% (p), fontsize=10)  
             ...
             #plt.suptitle('Difference from 120km LAM model (Model - 120km LAM) of Height, Specific Humidity and Wind Vectors  at %s hPa'% (p), fontsize=10) 
