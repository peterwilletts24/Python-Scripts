  ...
  # Set specific humidity min/max       
        ...
        for plot_diag in plot_diags:    
            ...
            for experiment_id in experiment_ids:
                ...
                pp_file = '%s_%s_on_p_levs_mean_by_day.pp' % (experiment_id, plot_diag)
                ...
                iris.coord_categorisation.add_day_of_year(pcube, time_coords, name='day_of_year')
                iris.coord_categorisation.add_day_of_year(height_cube, time_coords, name='day_of_year')
